...
import { addKidData, deleteKidData, getKidData, updateKidData } from '../../redux/action/kid.action';
...
function KidEra(props) {
    ...
    const KidFinData = useSelector(state => state.kidData)
    ...
    dispatch(updateKidData(NupData))
        setEid("");
        setValues();
        menObj.resetForm()
    }
